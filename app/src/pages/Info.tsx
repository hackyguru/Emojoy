...
function Header() {
  ...
  return <div style={{
    ...
    <Title style={{ textAlign: 'center', color: 'rgba(255, 255, 255, 0.75)' }}>Emojoy - Sahayak 2020</Title>
...
function AboutUs() {
  ...
  >
    ...
    <Row>
      <Col span={24}>
        <Text style={darkText}>This project is <b>non profit built at #SahayakHackathon</b>!</Text>
      </Col>
    </Row>
    <Row>
      <Col span={24}>
        ...
        <ul>
          <li style={bulletPoint}>Help us improving this project by sending us ideas! What features would you love to see? {<a href='mailto:kumaragurut7@gmail.com'>Send us an Email!</a>}</li>
          <li style={bulletPoint}>Are you a developer? {<a href="https://github.com/hackyguru/">Visit our Github page!</a>}</li>
          <li style={bulletPoint}>You can also {<a href='https://www.buymeacoffee.comm'>Buy us a coffee!</a>} to support us!</li>
        </ul>
      </Col>
    </Row>
  </div>
