...
export function AppFooter() {
  return <Footer style={{ textAlign: 'center' }}>
    Emojoy © 2020 by Team ICARU
    <Button type='link' icon='coffee' href='https://www.buymeacoffee.com/' />
    <Button type='link' icon='github' href='https://github.com/hackyguru' />
    <Button type='link' icon='mail' href='mailto:kumaragurut7@gmail.com' />
  </Footer>
}
